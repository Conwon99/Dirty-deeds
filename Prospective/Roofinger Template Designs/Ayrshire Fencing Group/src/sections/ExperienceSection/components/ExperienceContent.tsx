  ...
  return (
    <div className="box-border caret-transparent gap-x-[30px] flex flex-col justify-between gap-y-[30px] md:gap-x-[50px] md:gap-y-[50px]">
      <div className="box-border caret-transparent">
        ...
        <p className="text-sm sm:text-base box-border caret-transparent mt-2.5 mb-5 md:mt-5 md:mb-[50px] leading-relaxed">
        ...
        <a
          href="/about"
          className="text-orange-500 text-sm bg-gray-900 box-border caret-transparent inline-block leading-[19.6px] text-center border border-gray-900 px-5 py-2 rounded-[50px] border-solid md:text-lg md:leading-[25.2px] md:px-[30px] md:py-3 hover:text-gray-900 hover:bg-orange-500 hover:decoration-transparent"
        >
          More about us
        </a>
      </div>
