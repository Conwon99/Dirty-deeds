    ...
    <div className="box-border caret-transparent basis-[0%] grow max-w-[1100px]">
      <div className="box-border caret-transparent gap-x-4 flex flex-col gap-y-5 sm:gap-y-6">
        ...
        <h1 className="text-white text-[40px] font-semibold box-border caret-transparent blur-0 tracking-[-1.2px] leading-[48px] sm:text-[48px] sm:leading-[56px] md:text-8xl md:leading-[88px]">
          Fencing & Decking{" "}
          <span className="text-orange-500 text-[40px] italic box-border caret-transparent leading-[48px] sm:text-[48px] sm:leading-[56px] md:text-8xl md:leading-[88px]">
            Ayrshire
          </span>
        </h1>
        <div className="text-white text-base box-border caret-transparent blur-0 leading-[24px] sm:text-lg sm:leading-[28px] md:text-xl md:leading-[32px]">
          Bespoke fencing, sheds & gates, trellis, decking, palisade fencing, and fencing repairs — free quotes, insured contractors, over 13 years' experience. No job too big or small.
        </div>
      </div>
      <div className="items-center box-border caret-transparent gap-x-6 flex blur-0 flex-wrap gap-y-6 mt-7 md:gap-x-8 md:gap-y-8 md:mt-8">
        <div className="box-border caret-transparent flex">
          <a
            href="/contact"
            className="text-gray-900 items-center bg-orange-500 box-border caret-transparent gap-x-4 sm:gap-x-6 flex max-w-full gap-y-5 text-center border pl-6 pr-2 py-3 sm:pl-8 sm:py-2 md:pl-10 md:py-3 rounded-[100px] border-solid border-transparent hover:bg-white hover:border-orange-600 min-h-[56px] sm:min-h-[60px] md:min-h-[64px] touch-manipulation shadow-[0_0_20px_rgba(249,115,22,0.5),0_0_40px_rgba(249,115,22,0.3)] hover:shadow-[0_0_30px_rgba(249,115,22,0.7),0_0_60px_rgba(249,115,22,0.5)] transition-shadow duration-300"
          >
        ...
        <div className="box-border caret-transparent flex relative">
          <PhoneLink 
            ...
            iconAlt="Phone"
            className="relative items-center box-border caret-transparent gap-x-3 flex max-w-full gap-y-2 overflow-hidden hover:text-orange-500 min-h-[56px] sm:min-h-[60px] md:min-h-[64px] touch-manipulation"
