...
export const Hero = () => {
  return (
    <section id="home" className="relative bg-[url('/hero-bg.jpg')] bg-no-repeat bg-cover box-border caret-transparent min-h-screen w-full bg-[position:center_center] bg-[size:cover] pt-[100px] pb-[60px] md:pt-[120px] md:pb-[90px]">
