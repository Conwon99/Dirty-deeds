        ...
        <div className="box-border caret-transparent mb-[50px] md:mb-[70px]">
          ...
          <div className="box-border caret-transparent text-center mt-[30px] md:mt-[40px]">
            <a
              ...
              className="text-gray-900 text-sm font-bold bg-green-500 box-border caret-transparent inline-block leading-[19.6px] border border-green-500 px-5 py-2 rounded-[50px] border-solid md:text-lg md:leading-[25.2px] md:px-[30px] md:py-3 hover:text-white hover:bg-gray-900 hover:decoration-transparent"
            >
