...
export const ServiceCard = (props: ServiceCardProps) => {
    ...
    <>
      <div className="box-border caret-transparent">
        ...
        <div className="box-border caret-transparent">
          ...
          <p className="text-sm sm:text-base box-border caret-transparent my-[30px] md:my-[50px] leading-relaxed">
            {props.description}
          </p>
        </div>
      </div>
  ...
  return (
    <div className="relative items-start bg-slate-200 box-border caret-transparent flex flex-col justify-between max-w-full overflow-hidden p-5 rounded-r-[20px] rounded-tl-[20px] md:p-[30px]">
      {content}
    </div>
  );
};
