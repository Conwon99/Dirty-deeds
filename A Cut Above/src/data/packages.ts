 ...
 * Tree surgery services - A Cut Above Arborist.
 */
...
export const packagesData: PackageData[] = [
  {
    ...
    summary:
      "Safe roof steam cleaning with moss and algae removal from roof tiles. Professional treatment for lasting results and improved curb appeal. Suitable for all roof types across Perth and Kinross.",
    sections: [
      {
