...
const faqs: { question: string; answer: string }[] = [
  ...
  { question: "Do you come to me?", answer: "Yes. We're mobile and bring the equipment to you. We need a suitable space and power. We cover Perth and Kinross—get in touch to confirm." },
  ...
  { question: "What areas do you cover?", answer: "We cover Perth and Kinross and the surrounding area. Contact us with your location and we'll confirm we can reach you." },
];
    ...
    <section className="bg-white box-border py-[60px] md:py-[100px]">
      <div className="box-border max-w-[1204px] mx-auto px-5 md:px-8">
        <div className="box-border flex flex-col gap-y-8 md:gap-y-10">
          ...
          <h2 className="text-3xl font-bold tracking-[-0.52px] leading-[35px] md:text-[52px] md:leading-[62px] font-heading uppercase">Headlight Restoration FAQs</h2>
