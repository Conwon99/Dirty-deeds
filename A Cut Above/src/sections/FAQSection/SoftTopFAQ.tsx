...
const faqs: { question: string; answer: string }[] = [
  ...
  { question: "Do you come to me?", answer: "Yes. We're mobile and come to you. We need a suitable space and power. We cover Perth and Kinross—get in touch to confirm." },
    ...
    <section className="bg-white box-border py-[60px] md:py-[100px]">
      <div className="box-border max-w-[1204px] mx-auto px-5 md:px-8">
        <div className="box-border flex flex-col gap-y-8 md:gap-y-10">
          ...
          <h2 className="text-3xl font-bold tracking-[-0.52px] leading-[35px] md:text-[52px] md:leading-[62px] font-heading uppercase">Soft Top Restoration FAQs</h2>
