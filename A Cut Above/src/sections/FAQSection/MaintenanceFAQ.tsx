...
const faqs: { question: string; answer: string }[] = [
  ...
  },
  {
    ...
    answer:
      "Yes. We're mobile and come to you. We need a suitable space (e.g. driveway) and access to power. We cover Perth and Kinross—contact us to confirm we can reach you.",
  },
  {
    question: "What areas do you cover?",
    answer:
      "We cover Perth and Kinross and the surrounding area. Get in touch with your location and we'll confirm we can reach you.",
  },
];
