          ...
          <div className="box-border flex flex-col gap-y-16 md:gap-y-20">
            {byCategory.map(({ categoryId, label, packages, imageUrl }) => (
              <div key={categoryId}>
                ...
                <div className="relative rounded-xl overflow-hidden border border-[#4A552F] shadow-lg bg-[#1F2815] min-h-[100px] md:min-h-[120px] flex items-center justify-center p-6 md:p-8 mb-6 md:mb-8">
                  <img
                    src={imageUrl}
                    alt=""
                    ...
                    aria-hidden
                  />
                  <div className="absolute inset-0 bg-[#1F2815]/85" />
