  ...
  return (
    <>
      <a
        ...
        aria-label="Call A Cut Above Arborist"
        onClick={() => {
          if (typeof window !== 'undefined' && (window as any).gtag) {
            (window as any).gtag('event', 'phone_nav_mobile', {
              event_category: 'Phone',
              event_label: 'Mobile Navigation'
            });
          }
        }}
        className="mr-1 flex h-12 w-12 items-center justify-center rounded-full text-neutral-900 md:hidden"
      >
        <svg
          className="h-6 w-6"
          fill="none"
        ...
        >
          <path
            ...
            strokeWidth={2}
            d="M3 5.75C3 4.784 3.784 4 4.75 4h2.086c.764 0 1.44.49 1.677 1.216l.805 2.472a1.75 1.75 0 01-.456 1.78l-1.066 1.066a12.042 12.042 0 005.67 5.67l1.066-1.066a1.75 1.75 0 011.78-.456l2.472.805A1.75 1.75 0 0120 17.164v2.086A1.75 1.75 0 0118.25 21h-.5C9.603 21 3 14.397 3 6.25v-.5z"
          />
        </svg>
      </a>
      <button
