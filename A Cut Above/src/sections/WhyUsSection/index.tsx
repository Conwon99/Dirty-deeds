                ...
                <div className="box-border caret-transparent blur-0 max-w-none md:max-w-[360px]">
                  <div className="text-neutral-700 box-border caret-transparent">
                    <div className="text-[15px] box-border caret-transparent leading-6 md:text-base">
                      We deliver professional tree surgery across Perth and Kinross. Fully qualified, with the right equipment and safe methods for pruning, removals, stump grinding, hedge cutting and emergency tree work.
                    </div>
                  </div>
                </div>
              </div>
