    ...
    >
      <div className="flex items-center justify-center gap-2 md:gap-3 mb-1.5 md:mb-2">
        <div className="flex-shrink-0">
          <svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="md:w-6 md:h-6">
        ...
        <div className="text-white text-xl md:text-2xl font-bold">5.0</div>
