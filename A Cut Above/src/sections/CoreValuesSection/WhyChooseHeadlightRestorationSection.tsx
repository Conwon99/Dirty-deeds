          ...
          <div className="box-border caret-transparent blur-0 basis-[0%] grow max-w-none md:max-w-[544px]">
            ...
            <div className="box-border caret-transparent mt-[18px] mb-4 md:mt-5">
              <h2 className="text-3xl font-bold box-border caret-transparent tracking-[-0.52px] leading-[35px] md:text-[52px] md:leading-[62px] font-heading uppercase">
                ...
                <span className="font-heading uppercase">Choose Our Headlight Restoration?</span>
              </h2>
            </div>
            <div className="text-neutral-700 box-border caret-transparent space-y-4">
              <div className="text-[15px] box-border caret-transparent leading-6 md:text-base">
                Cloudy or yellowed headlights reduce visibility and age the look of your car. We restore them using professional polishing and, where appropriate, UV-resistant sealant or coating so they stay clear for longer.
              </div>
              <div className="text-[15px] box-border caret-transparent leading-6 md:text-base">
                We work on plastic and glass lenses and can combine headlight restoration with a full detail or do it as a standalone service. We come to you with the right equipment for a lasting result.
              </div>
            </div>
                ...
                <div className="box-border caret-transparent gap-x-3 flex items-start gap-y-2">
                  <div className="text-black items-center bg-neutral-200 box-border caret-transparent flex h-6 justify-center w-6 overflow-hidden rounded-[50%] shrink-0 mt-0.5">
                    <div className="items-center box-border caret-transparent flex h-4 justify-center w-4">
                      <svg className="h-full w-full" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    </div>
                  </div>
                  <div className="text-[15px] box-border caret-transparent leading-6 text-neutral-700 md:text-base">Quality Products - Professional-grade abrasives and UV protection for lasting clarity</div>
                </div>
                <div className="box-border caret-transparent gap-x-3 flex items-start gap-y-2">
                  <div className="text-black items-center bg-neutral-200 box-border caret-transparent flex h-6 justify-center w-6 overflow-hidden rounded-[50%] shrink-0 mt-0.5">
                    <div className="items-center box-border caret-transparent flex h-4 justify-center w-4">
                  ...
                  <div className="text-[15px] box-border caret-transparent leading-6 text-neutral-700 md:text-base">Mobile Service - We bring headlight restoration to your home or workplace</div>
                </div>
                <div className="box-border caret-transparent gap-x-3 flex items-start gap-y-2">
                  <div className="text-black items-center bg-neutral-200 box-border caret-transparent flex h-6 justify-center w-6 overflow-hidden rounded-[50%] shrink-0 mt-0.5">
                    <div className="items-center box-border caret-transparent flex h-4 justify-center w-4">
