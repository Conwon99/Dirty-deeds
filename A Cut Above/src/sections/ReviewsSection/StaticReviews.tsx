...
const REVIEWS = [
  {
    name: "Sarah M.",
    meta: "Local homeowner",
    time: "Placeholder review",
    initial: "S",
    initialBg: "bg-violet-400",
    text: "Cameron was professional from the first message through to completion. He removed a problem tree safely, explained the work clearly and left the garden tidy. I would happily recommend him.",
  },
  {
    name: "James R.",
    meta: "Local customer",
    ...
    text: "Excellent service from Cameron. The hedge cutting and tree pruning were carried out carefully and the finished result looks great. Reliable, polite and easy to deal with.",
  },
  {
    name: "Fiona T.",
    meta: "Local homeowner",
    ...
    text: "Cameron came out after storm damage and made everything safe quickly. The fallen branches were removed, the area was cleared and the whole job was handled with real care.",
  },
];
