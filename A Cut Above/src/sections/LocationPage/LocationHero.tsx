...
import locationHeroImageUrl from "../../../ImagesPhotos/670298543_18085986425056361_7899633911350532168_n.jpg?url";
...
export const LocationHero = ({ location }: LocationHeroProps) => {
  ...
  const areas = neighborhoods.length
    ? ` in ${name} and nearby areas like ${neighborhoods.slice(0, 3).join(", ")}`
    : ` in ${name}`;
    ...
    <section className="relative text-white overflow-hidden min-h-screen">
      <div className="absolute inset-0">
        <div
          ...
          style={{
            backgroundImage: `url("${locationHeroImageUrl}")`,
          ...
          <div className="box-border basis-[0%] grow max-w-[650px]">
            <div className="box-border gap-x-4 flex flex-col gap-y-4">
              ...
              <p className="text-base leading-[26px] md:text-lg font-figtree">
                Professional arborist and tree surgeon services{areas}. Tree pruning, removals, stump grinding, hedge maintenance, fallen tree clearance and 24 hour emergency tree work.
              </p>
            </div>
            <div className="items-center box-border gap-x-5 flex flex-wrap gap-y-5 mt-6 md:gap-x-6 md:gap-y-6 md:mt-7">
              ...
              >
                ...
                <span className="text-white items-center bg-[#5F6F3A] box-border flex h-12 justify-center w-12 overflow-hidden rounded-[50%]">
                  <img
                    src={ICON_ARROW}
                    alt=""
