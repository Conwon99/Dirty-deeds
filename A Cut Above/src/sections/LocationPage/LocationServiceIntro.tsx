...
import aboutImageUrl from "../../../ImagesPhotos/arborist_hero.png?url";
      ...
      <div className="box-border caret-transparent max-w-[1204px] mx-auto px-5 md:px-8">
        <div className="box-border caret-transparent gap-x-7 flex flex-col justify-between gap-y-7 md:gap-x-10 md:flex-row md:gap-y-10">
          ...
          <div className="box-border caret-transparent gap-y-4 flex flex-col w-full max-w-full md:max-w-none md:w-auto md:max-w-[700px]">
            <div className="box-border caret-transparent blur-0 h-[300px] w-full overflow-hidden rounded-2xl md:h-[600px] md:w-full">
              <img
                ...
                alt={`A Cut Above Arborist - tree surgery in ${name}`}
          ...
          <div className="box-border caret-transparent blur-0 basis-[0%] grow max-w-none md:max-w-[544px]">
            <div className="box-border caret-transparent inline-block border border-[#D6DDC2] px-3 py-1 rounded-[1000px] border-solid">
            ...
            <div className="box-border caret-transparent mt-[18px] mb-4 md:mt-5">
              <h2 className="text-3xl font-bold box-border caret-transparent tracking-[-0.52px] leading-[35px] md:text-[52px] md:leading-[62px] font-heading uppercase">
                <span className="text-3xl box-border caret-transparent leading-[35px] font-heading uppercase md:text-[52px] md:leading-[62px]">Why</span> <span className="font-heading uppercase">Choose A Cut Above Arborist?</span>
              </h2>
            </div>
            <div className="text-neutral-700 box-border caret-transparent">
              <p className="text-[15px] box-border caret-transparent leading-6 md:text-base">
                At A Cut Above Arborist we deliver professional tree surgery across Perth and Kinross—including {name}{neighborhoods.length ? ` and nearby areas` : ""}. From pruning and crown reductions to removals, stump grinding, hedge cutting and emergency tree work, we bring safe, qualified service to your property.
              </p>
            ...
            <div className="box-border caret-transparent mt-6 pt-6 border-t border-[#D6DDC2]">
