        ...
        <div className="box-border caret-transparent">
          <div className="box-border caret-transparent gap-x-4 flex flex-col gap-y-4">
            ...
            <div className="box-border caret-transparent blur-0 max-w-[680px] text-center mx-auto">
              ...
              <p className="text-[15px] box-border caret-transparent leading-6 text-neutral-700 mt-3 md:text-base">
                Fully qualified arborists offering domestic and commercial tree care, including emergency callouts.
              </p>
            </div>
          </div>
          ...
          <div className="box-border caret-transparent mt-6 text-center max-w-[800px] mx-auto">
            <p className="text-[15px] box-border caret-transparent leading-6 text-neutral-700 md:text-base">
              These are our most requested services. If you need another type of tree work, contact us and we will help.
            </p>
          </div>
