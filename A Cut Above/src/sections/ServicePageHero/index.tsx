import servicesHeroImageUrl from "../../../ImagesPhotos/670298543_18085986425056361_7899633911350532168_n.jpg?url";
      ...
      <div className="box-border caret-transparent max-w-[1204px] mx-auto px-5 md:px-8">
        <div className="box-border caret-transparent pb-[60px] md:pb-[100px]">
          ...
          <div className="box-border caret-transparent blur-0 h-[220px] overflow-hidden mt-7 rounded-2xl md:h-[642px] md:mt-10">
            <img
              src={servicesHeroImageUrl}
              sizes="100vw"
              alt="Professional tree surgeon and arborist services"
